...
<div class="container col-4 mt-5" id="cont">
<div class="d-flex align-items-center justify-content-center">
   <h3 class="text-warning p-3">Add a New Product Page</h3>
</div>

   <div class="modal-body">

      <form  action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" class=" p-5" style="background-color:black">
      <div class="d-flex align-items-center justify-content-center">
         <h3 class="text-dark">Add a New Product</h3>
      </div>
      ...
      <table class="table">
         ...
         <tr>
            ...
            <td class="align-middle text-center">
               <a  href="admin_update.php?edit=<?php echo $row['id']; ?>" class="btn btn-success"> <i  class="fas fa-edit size " ></i> Edit </a>
               <a  href="admin_page.php?delete=<?php echo $row['id']; ?>" class="btn btn-info"> <i  class="fas fa-trash size "></i> Delete </a>
            </td>
         </tr>
         </tbody>
      <?php } ?>
